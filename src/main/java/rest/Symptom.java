...
public class Symptom  {
    ...
    public boolean equals(Object object) {
    	...
    	if (!(object instanceof Symptom)) return false;    	
    	Symptom s = (Symptom)object;
    	return s.getUniqueName().equals(getUniqueName()) && getValue() == s.getValue() && s.getMin() == getMin() && s.getMax() == getMax();
    }
